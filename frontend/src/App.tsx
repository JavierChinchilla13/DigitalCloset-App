...
const OutfitsPage = () => <div className="text-center py-40"><h1 className="text-4xl font-light uppercase tracking-tighter text-white">Saved Outfits</h1><p className="text-text-secondary mt-4">Collection view coming soon.</p></div>;
