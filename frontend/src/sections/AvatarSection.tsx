    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden py-32 bg-background-main">
      ...
      >
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="text-[10px] font-black tracking-[0.4em] text-accent uppercase">Persona Core</span>
        </div>
        ...
        <div className="mt-12 flex flex-col items-center gap-10 w-full px-6">
          ...
          >
            ...
            >
              ...
              <span className="text-[11px] tracking-[0.2em] uppercase">Initialize Outfit</span>
            ...
            >
              ...
              <span className="text-[11px] tracking-[0.2em] uppercase">Configure Persona</span>
            </Link>
          </motion.div>
        </div>
      </div>
      ...
      <div className="hidden lg:block absolute left-12 top-1/2 -translate-y-1/2 -rotate-90">
        <p className="text-[8px] font-black tracking-[0.5em] text-white/20 uppercase">Digital Closet System v2.0 // Node: Persona_Main</p>
      </div>
      <div className="hidden lg:block absolute right-12 top-1/2 -translate-y-1/2 rotate-90">
        <p className="text-[8px] font-black tracking-[0.5em] text-white/20 uppercase">Biometric Data: {persona.type} // Sync: Stable</p>
      </div>
    </section>
  );
};
