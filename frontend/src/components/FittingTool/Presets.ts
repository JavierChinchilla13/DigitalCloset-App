...
export const DEFAULT_TRANSFORMS: Record<PersonaType, Record<ClothingCategory, ClothingTransform>> = {
  [PersonaType.MALE]: {
    ...
    export const SHOE_PAIR_PRESETS: Record<PersonaType, { left: ClothingTransform, right: ClothingTransform }> = {
    [PersonaType.MALE]: {
    left: { x: 300, y: 940, scaleX: 1, scaleY: 1, rotation: 0, width: 260, height: 160 },
    right: { x: 450, y: 940, scaleX: 1, scaleY: 1, rotation: 0, width: 260, height: 160, flipX: true }
    },
    [PersonaType.FEMALE]: {
    left: { x: 310, y: 930, scaleX: 1, scaleY: 1, rotation: 0, width: 240, height: 140 },
    right: { x: 440, y: 930, scaleX: 1, scaleY: 1, rotation: 0, width: 240, height: 140, flipX: true }
    }
    };
